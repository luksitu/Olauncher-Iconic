...
class Prefs(context: Context) {
    ...
    private val HOME_DISPLAY_MODE = "HOME_DISPLAY_MODE"
    ...
    var homeDisplayMode: Int
        get() = prefs.getInt(HOME_DISPLAY_MODE, Constants.HomeDisplayMode.ICON_AND_TEXT)
        set(value) = prefs.edit { putInt(HOME_DISPLAY_MODE, value).apply() }
